...
# include "red_black_tree_iterator_set.hpp"
# include "red_black_tree.hpp"
...
namespace ft {
    ...
    public:
        ...
        typedef pair<Key, int>         value_type_rbt;

        typedef Compare     key_compare;
        typedef Compare     value_compare;
        typedef Allocator   allocator_type;

        typedef typename ft::Red_black_tree< key_type, value_type_rbt, key_compare, allocator_type>	tree_type;
		...
		typedef typename tree_type::Node<value_type_rbt>*						node_pointer;

		typedef ft::Rbt_iterator_set<const value_type, node_pointer, Compare>					iterator;
		typedef ft::Rbt_iterator_set<const value_type, node_pointer, Compare>			const_iterator;
        ...
        { 
            return RB_Tree.insert(make_pair(x, 0));
        }
